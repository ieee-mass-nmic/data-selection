...
\begin{itemize}
    ...
    \item \textbf{Evaluation.} Across GSM8K, HumanEval, MMLU, and TyDiQA, PCU-Select improves 10\%-budget downstream performance over random by 3.64 points and RDS+ by 0.98 points. It attains downstream performance statistically indistinguishable from per-PEFT LESS while amortizing its offline selection cost after about 1.6 target PEFT configurations.
\end{itemize}
