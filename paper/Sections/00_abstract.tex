...
configuration from 63.2 to 1.44 GPU-hours, a $44\times$ reduction, and cuts the
five-configuration selection cost from 316.0 to 151.2 GPU-hours. It maintains average downstream quality comparable to LESS. PCU-Select thus replaces
repeated per-configuration computation with reusable offline processing.
