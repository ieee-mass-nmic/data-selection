...
SEED_RNG = np.random.default_rng(20261031)
...
GRID_RAW = {
    ...
    "HumanEval": {
        ...
        "PCU-Select": [(17.23, 0.41), (16.97, 0.36), (17.78, 0.28), (16.14, 0.68), (17.18, 0.12)],
    },
    "MMLU": {
    ...
    "TyDiQA": {
        ...
        "PCU-Select": [(52.69, 0.57), (51.76, 0.72), (53.51, 0.39), (51.16, 0.62), (52.38, 0.64)],
    },
}
END_TAB = "\n\\bottomrule\n\\end{tabular}\n\\end{table}\n"
END_TABSTAR = "\n\\bottomrule\n\\end{tabular}\n\\end{table*}\n"
